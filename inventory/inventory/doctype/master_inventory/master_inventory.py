		...
		for i in get_data :
			if i[5] :
				...
				if cek_data :
					...
					new_total_roll = current_total_roll - i[7]
					new_total_yard = current_total_yard - i[8]
					...
					frappe.db.sql ("""
						...
						AND di.`inventory_uom` = "{7}"
						 ...
						 """.format(new_total_roll,new_total_yard,i[1],i[2], i[3], i[4], i[5], i[6]))
				...
				if cek_data :
					...
					frappe.db.sql ("""
						...
						AND di.`inventory_uom` = "{6}"
						 ...
						 """.format(new_total_roll,new_total_yard,i[1],i[2], i[3], i[4], i[6]))
